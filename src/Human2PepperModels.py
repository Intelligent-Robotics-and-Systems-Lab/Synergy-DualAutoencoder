...
def model1():
    ...
    descript = "Human with layer encoder [18,14,10,14,18] and no dropout\nPepper with layer encoder [40,25,10,25,40] and no dropout\nUsing 10 latent features"
    ...
    print("Creating Pepper autoencoder layers")
    encodeP = [
        Dense(25,activation=lrelu(alpha=0.01)),
        Dense(10,activation=lrelu(alpha=0.01)),
        ]
    decodeP = [
        Dense(25,activation=lrelu(alpha=0.01)),
        Dense(40,activation='pepperactivation'),
        ]

    # Create student-teacher model
    model = CycleGANModel(18,40)
...
def model2():
    # Need to identify this model
    descript = "Human with layer encoder [18,16,14,12,10,12,14,16,18] and no dropout\nPepper with layer encoder [40,32,24,16,10,16,24,32,40] and no dropout\nUsing 10 latent features"
    ...
    print("Creating Pepper autoencoder layers")
    encodeP = [
        Dense(32,activation=lrelu(alpha=0.01)),
        Dense(24,activation=lrelu(alpha=0.01)),
        Dense(16,activation=lrelu(alpha=0.01)),
        Dense(10,activation=lrelu(alpha=0.01)),
        ]
    decodeP = [
...
def model3():
    # Need to identify this model
    descript = "Human with layer encoder [18,14,10,6,10,14,18] and no dropout\nPepper with layer encoder [40,30,20,10,6,10,20,30,40] and no dropout\nUsing 6 latent features"
    ...
    print("Creating Pepper autoencoder layers")
    encodeP = [
        Dense(30,activation=lrelu(alpha=0.01)),
        Dense(20,activation=lrelu(alpha=0.01)),
        Dense(10,activation=lrelu(alpha=0.01)),
        Dense(6,activation=lrelu(alpha=0.01)),
        ]
    decodeP = [
